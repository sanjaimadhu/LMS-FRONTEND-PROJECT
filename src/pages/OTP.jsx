...
const OTP = () => {
  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <Link 
    to={"/register"} className="border-2 border-black rounded-3xl font-bold w-52 py-2 px-4 fixed
        ...
        <div className="rounded-full flex items-center justify-center">
          ...
          <h1 className="text-4xl font-medium text-center mb-12 overflow-hidden"> 
            ...
            <p className="text-gray-900 text-center mb-12">
             Please Enter The Otp To Proceed </p>
             <form onSubmit={handleOtpVerification}>
              ...
              py-2 rounded-lg
              hover:bg-white hover:text-black transition"> VERIFY </button>
             </form>
             </div>
            </div>
    {/* RIGHT SIDE */}
